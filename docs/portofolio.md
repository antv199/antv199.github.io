...
!!! info "Oct 2021 – Sep 2026 | Bachelor's degree, Informatics and Telecommunications"
...
??? abstract "Jul 2026 - Aug 2026 | Internship @ [ETVA VIPE](https://www.etvavipe.gr/) (Industrial Business Parks)"
    * **Location:** Sindos, Thessaloniki, Greece - On-site
    * **Duration:** 2 mos (Full-time)
    * **Details:** Automation of SCADA systems for industrial processes, including data acquisition, monitoring, and control. Assisted in the development of a web-based dashboard for real-time visualization of process parameters.
    * **Skills:** 

??? abstract "Nov 2023 - May 2024 | Assistant Accountant @ [Biolab Laboratories](https://biolab.com.gr/) (Food, Environmental & Agricultural Testing Laboratory)"
    * **Location:** Arta, Epirus, Greece - On-site
    * **Duration:** 7 mos (Part-time)
    * **Details:** Managed daily operations on Soft1 Cloud ERP, including financial data entry, invoicing, and vendor account reconciliation...
    * **Skills:** Windows, Excel, Word, Soft1 Cloud ERP
...
??? abstract "2015 - 2023 | Freelance IT Technician & HomeLab Administrator @ Self-employed"
    ...
    * **Skills:** Markdown, Batch Programming and +15 skills
...
!!! success "May 2025 | Recipe Manager Mobile App"
    * **Associated with:** University of Ioannina
    * **Details:** Developed a cross-platform mobile application for personal recipe management using Flutter. The app allows users to...
    * **Skills:** Dart, Flutter
...
!!! quote "Mar 2022 - Present | Open Source Contributor (Localization & Translation)"
    * **Organization:** Open Source Community (Science and Technology)
    * **Details:** Contributing to the Greek localization (L10n) of open-source software projects via Crowdin and Weblate, with a focus on tools related to privacy, self-hosting, and development.
    * **Key Projects:**
        * **Self-Hosting & Home-Lab:** Kavita (Self-Hosted Digital Library Server), NextDNS
        * **Communication & Privacy:** Mumble (Low-latency VoIP), SimpleX Chat, Session (Encrypted Messenger), InviZible Pro
        * **Gaming & Dev Tools:** Godot Engine, Prism Launcher (Open Source Minecraft Launcher)
